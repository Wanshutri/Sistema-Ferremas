        ...
        <Offcanvas.Header closeButton>
          <div className="offcanvas-header">
            <h5 className="offcanvas-title" id="offcanvasDarkNavbarLabel">
              <img src={logo} className="logoFerremas" />
            </h5>
            <button
              type="button"
              className="btn-close btn-close-white b2"
        ...
        <Offcanvas.Body>
          <Link to="/">
            <Button className="btn btn-primary b1" aria-current="page">
              <FontAwesomeIcon icon={faHouse} className="iconleftmenu" />
              Home
            </Button>
          </Link>
          ...
          <Link to="/sobrenosotros">
            <Button className="btn btn-primary b1" aria-current="page">
              <FontAwesomeIcon icon={faUsers} className="iconleftmenu" />
              Sobre nosotros
            </Button>
          </Link>
          ...
          <Link to="/carro">
            <Button className="btn btn-primary b1">
              <FontAwesomeIcon icon={faCartShopping} className="iconleftmenu" />
              Carrito
            </Button>
          </Link>
          <Button
            ...
            aria-controls="collapse-contacto"
            aria-expanded={open}
          >
            <FontAwesomeIcon icon={faMessage} /> Info
            <Collapse in={open}>
              <div id="collapse-contacto">
                <li>
                  <a>
                    <FontAwesomeIcon icon={faReceipt} /> Formulario
                  </a>
                </li>
                <li>
                  <a>
                    <FontAwesomeIcon icon={faWhatsapp} /> Escribenos al
                    +56945020474
                  </a>
                </li>
                <li>
                  <a>Visitanos en Villa Ferroviaria</a>
                </li>
              </div>
            </Collapse>
          </Button>
          <Form className="d-flex mt-3 sb1" role="search">
            <input
              className="form-control me-2 sb2"
              type="search"
              placeholder="¿Qué deseas buscar?"
              aria-label="Search"
            />
            <button className="btn btn-primary b2" type="submit">
              {" "}
