...
const Carousel = ({ imagen1, imagen2 }) => {
    ...
    return (
        <div id="carouselExampleAutoplaying" className="carousel slide c1" data-bs-ride="carousel" style={{ marginTop: "30px", marginBottom: "50px" }}>
                                ...
                                <div className="card " style={{width: "17rem"}}>
                                    <img src={imagen1} className="card-img-top " alt="..."/>
                                        <div className="card-body">
                                            <h5 className="card-title">Card title</h5>
                                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            <a href="#" Name="btn btn-primary">Ver mas detalles</a>
                                        </div>
                                </div>
                            </div>
                        </div>
