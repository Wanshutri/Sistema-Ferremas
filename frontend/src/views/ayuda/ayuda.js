                          ...
                          <div className="divacordion">
                            <Accordion>
                              <AccordionSummary
                                ...
                                id="panel1-header"
                              >
                                <Typography className="titulotipografia1">
                                  <strong>
                              ...
                              <AccordionDetails>
                                <Typography className="tipografia1">
                                  Nuestro horario de atención es de lunes a
                                  viernes de 8:00 a.m. a 6:00 p.m. y los sábados
                            ...
                            <Accordion>
                              ...
                              <AccordionDetails>
                                <Typography className="tipografia1">
                                  Sí, ofrecemos entregas a domicilio dentro de
                                  un radio de 10 kilómetros. Consulta con
                                  nuestro equipo para más detalles y costos de
                                  envío.
                                </Typography>
                              </AccordionDetails>
                            </Accordion>
                            <Accordion>
                              ...
                              <AccordionDetails>
                                <Typography className="tipografia1">
                                  ...
                                  posteriores a la compra, siempre y cuando los
                                  productos estén en su estado original y se
                                  presenten con el recibo de compra. Algunos
                                  artículos pueden estar sujetos a políticas de
                                  devolución específicas, así que asegúrate de
                                  preguntar al momento de la compra.
                                </Typography>
                              </AccordionDetails>
                            </Accordion>
                            <Accordion>
                              ...
                              >
                                <Typography className="titulotipografia1">
                                  <strong>
                                    ¿Tienen descuentos para contratistas o
                              ...
                              <AccordionDetails>
                                <Typography className="tipografia1">
                                  ...
                                  contratistas y compras al por mayor. Por
                                  favor, contacta a nuestro equipo de ventas
                                  para obtener más información sobre nuestras
                                  tarifas especiales y cómo registrarte.
                                </Typography>
                              </AccordionDetails>
                            </Accordion>
                            <Accordion>
                              ...
                              >
                                <Typography className="titulotipografia1">
                                  <strong>
                                    ¿Pueden ayudarme a encontrar un producto
                                    específico?
                                  </strong>
                                </Typography>
                              </AccordionSummary>
                              <AccordionDetails>
                                <Typography className="tipografia1">
                                  Absolutamente. Nuestro personal está altamente
                                  capacitado y estará encantado de ayudarte a
                                  encontrar el producto que necesitas. Si no lo
                                  tenemos en stock, haremos todo lo posible por
                                  conseguirlo para ti.
                                </Typography>
                              </AccordionDetails>
                            </Accordion>
